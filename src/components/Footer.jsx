        ...
        <section className="w-[100%] flex flex-col px-8 lg:w-11/12 py-6 md:text-[0.8rem] ">
            <div className="flex gap-20 md:gap-6 lg:gap-0 flex-wrap justify-between py-12 ">
                <div className="flex flex-col items-center gap-3 w-full md:w-[25%]">
                    <Image src="logo.svg" alt="Wellness" width={119} height={120}/>
            ...
            <p className="flex justify-center item-center md:self-start gap-2"><span className="opacity-60 ">Powered by</span><Image src="wlogo.svg" width={70} height={40} alt="WellnessZ"/></p>
