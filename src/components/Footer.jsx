...
export default function Footer() {
    return (
        <section className="w-full flex justify-center bg-white">
            <section className="w-[100%] flex flex-col px-8 lg:w-11/12 py-6 md:text-[0.8rem] ">
                <div className="flex gap-20 md:gap-6 lg:gap-0 flex-wrap justify-between py-12 ">
                    <div className="flex flex-col items-center gap-3 w-full md:w-[25%]">
                        <Image loading="lazy" src="logo.svg" alt="Wellness" width={119} height={120} />
                        <div className="flex gap-6 cursor-pointer text-[1.1rem] text-primary ">
                            <FaFacebookF />
                            <FaTwitter />
                            <FaInstagram />
                            <FaLinkedinIn />
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="opacity-60 flex items-center gap-3"><FaRegEnvelope /> support@veewellness.com</div>
                        <div className="opacity-60 flex items-center gap-3"><FaPhoneAlt /> +91 9876543210</div>
                        <div className="opacity-60 flex items-center gap-3"><FaLocationDot /> Rohini, Delhi, India</div>
                    </div>
                </div>

                <p className="flex justify-center item-center md:self-start gap-2"><span className="opacity-60 ">Powered by</span><Image loading="lazy" src="wlogo.svg" width={70} height={40} alt="WellnessZ" /></p>
                ...
                <div className="flex flex-col md:flex-row gap-2 items-center justify-between border-t-2 pt-4 border-gray-500">
                    ...
                    <div className="flex flex-col md:flex-row gap-2 items-center justify-center">
                        ...
                        <div className="text-[0.7rem] md:text-[0.8rem]">
                            <u className="text-primary px-2 border-x-2 cursor-pointer border-gray-500">Terms and Conditions</u>
                            <u className="text-primary px-2 cursor-pointer ">Privacy Policy</u>
                        </div>
                    </div>
                </div>
            </section>
