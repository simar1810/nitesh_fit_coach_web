    ...
    <div className="">
      ...
      <div className="h-[40vh] sm:h-[50vh] md:h-[75vh] lg:h-[95vh] bg-[url('/s1mobile.png')] bg-cover bg-top-center p-8">
        <div className="max-w-[1200px] h-full bg-red- 200 text-white mx-auto px-8 hidden md:flex flex-col">
          ...
          <p className="max-w-[64ch] text-[15px] leading-[1.2] mt-[12px]">
            ...
            AI-powered tools, and expert guidance to help you manage or prevent
            diabetes.
          </p>
          <Link
            target="_blank"
      ...
      <div className="w-full bg-[var(--accent-1)] text-white flex justify-center items-center p-4 pt-8 pb-28 md:p-[4rem] md:pb-32 relative">
        <div className="max-w-[1200px] mx-auto lg:flex flex-row justify-between items-start">
          ...
          <Image
            src="/logo_1.png"
            className="absolute w-[110px] lg:w-[330px] aspect-square bottom-0 left-1/2 lg:left-0 translate-x-[-50%] lg:translate-x-[20%] xl:translate-x-[40%] object-bottom object-contain"
            height={548}
            width={548}
            alt="lightened image of Nitesh Fit Coach logo"
          />
        </div>
      </div>
      ...
      <div className="text-center px-[20px] py-[28px] md:py-[40px]">
        ...
        <h2 className="text-[24px] md:text-[48px] font-semibold text-center leading-[1.2] mb-[8px] md:mb-[48px]">
        ...
        <div className="max-w-[1200px] mx-auto lg:flex gap-[40px]">
          <Image
            height={1024}
            width={1024}
            src="/clubTrainer1.webp"
            alt="image of Nitesh Fit Coach coaches"
          ...
          <div className="mt-[20px] lg:mt-0">
            <h2 className="text-[20px] md:text-[36px] font-semibold text-center text-[var(--accent-1)] leading-[] mb-[8px] md:mb-[12px]">
              Nitesh Jaithlya&nbsp;
              <span className="text-black">&</span>&nbsp; Tara Jaithlya
            </h2>
            <p className="max-w-[70ch] text-[#00000080] text-center text-[12px] md:tex t-[16px] text-left leading-[1.1] mx-auto mb-[60px] md:mb-[20px]">
              Are you ready to transform your fitness journey? Setting clear,
              achievable goals is the first step towards success. Whether
              you&nbsp;re aiming to lose weight, build muscle, or improve
              endurance, a diverse workout routine incorporating cardio,
              strength, and flexibility exercises will help you reach your
              targets.
            </p>
            <div className="md:flex items-center justify-center gap-4">
              <div>
                <Image
                  src="/homePeople.webp"
                  alt="Nitesh Fit Coach coaches transformation"
                  height={1024}
                  width={1024}
      ...
      <div className="bg-gradient-to-tr from-[#449B9E1A] via-[#16BA980D] to-[#16A7621A] text-center px-4 py-[3rem] p b-[5rem] gap-3 w-full">
        ...
        <p className="max-w-[60ch] text-[10px] md:text-[14px] text-center mx-auto mb-[12px] md:mb-[16px]">
          Nitesh Fit Coach combines the power of science-backed nutrition with
          personalized guidance to help you reclaim your health and live
          diabetes-free.
        </p>
        <button className="rounded-full text-white bg-[var(--accent-1)] text-[12px] md:text-[16px] font-semibold py-2 px-4">
          Download Now
        </button>
          ...
          {trustedPartners.map((item, index) => (
            ...
            >
              ...
              {index === 3 && (
                <div
                  className={
                    "w-full absolute text-white top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-center"
                  }
                >
                  + Many More
                </div>
      ...
      <div className="hidden w-full h-full bg-[url('/s4.svg')] bg-cover md:flex flex-col justify-center items-start px-[20px] py-[3rem] gap-3">
        <div className="max-w-[1200px] mx-auto">
          <h1 className="text-[24px] md:text-[48px] font-bold text-left text-white leading-[1.2]">
            Classes for Every Level <br /> and Intention
          </h1>
          <p className="text-[8px] md:text-[16px] md:max-w-[60ch] xl:max-w-[35%] text-left text-white">
          ...
          <div className="max-w-[1200px] w-full flex flex-wrap justify-between gap-3 mt-[12rem]">
            {classSection.map((item, index) => (
              <div
                key={index}
                className="w-[calc(50%-6px)] lg:w-[calc(25%-12px)] rounded-xl bg-white flex flex-col items-start text-left p-4 gap-3 md:gap-1 cursor-pointer transition-all duration-200 shadow-xl"
              >
                ...
                <h1 className="text-[24px] md:text-[1.2rem] font-semibold mt-2 leading-[1.2]">
                  {item.h}
                </h1>
                <p className="text-[10px] text-gray-500 leading-[1.2] text-[#00000080]">
                  {item.d}
                </p>
              </div>
            ))}
      ...
      <div className="md:hidden">
        <div className="w-full h-full bg-[url('/s4.svg')] bg-cover flex flex-col justify-center items-start px-4 md:px-[4rem] pt-[100px] pb-[40px] gap-3">
          <h1 className="text-[22px] font-bold leading-[1.2] text-left text-white mt-12">
            Classes for Every Level <br /> and Intention
          </h1>
          <p className="text-[10px] max-w-[60ch] text-left text-white">
            From beginner-friendly sessions to advanced health workshops, our
            programs are designed to meet you where you are.
          </p>
        </div>
        <div className="w-full flex flex-wrap justify-between gap-3 p-3 my-4">
          {classSection.map((item, index) => (
            <div
              key={index}
              className="w-[48%] rounded-xl bg-white text-left p-4 gap-3 md:gap-1 cursor-pointer shadow-xl transition-all duration-200 mt-2"
            >
              ...
              <h1 className="text-[12px] leading-[1.2] font-semibold my-[8px]">
                {item.h}
              </h1>
      ...
      <div className="bg-gradient-to-tr from-[#0168A826] via-[#0168A826] to-[#0168A826] px-4 py-[3rem] w-full">
        <h2 className="text-[24px] md:text-[48px] font-semibold text-center leading-[1.2] mb-[8px] md:mb-[12px]">
          Why Choose Nitesh Fit Coach
        </h2>
        <p className="max-w-[60ch] text-[10px] md:text-[14px] text-center text-[#00000080] mx-auto mb-[12px] md:mb-[16px]">
          Why you should choose us. Join Our Diabetes Prevention Challenges.
          Start a step-by-step journey with the support of experts and a
          like-minded community.
        </p>
        <button className="rounded-full text-white bg-[var(--accent-1)] text-[12px] md:text-[16px] font-semibold block mx-auto py-2 px-4">
          Join us Today
        </button>
      ...
      <div className="bg-gradient-to-t from-[#0168A880] via-[#FFFFFF] to-[#FFFFFF] flex flex-col justify-center items-center px-4 pt-[20px] pb-[48px] md:py-[80px] gap-3 w-full relative overflow-hidden">
        ...
        <p className="text-[8px] md:text-[14px] max-w-[60ch] text-center mx-auto">
          ...
          preventing diabetes. Share experiences, learn together, and grow
          stronger.
        </p>
        <Link
          target="_blank"
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="flex gap-20 md:gap-6 lg:gap-0 flex-wrap justify-between py-12 ">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Link
                href="mailto:niteshk.jaithlya@gmail.com"
                className="opacity-60 flex items-center gap-3"
              >
                <FaRegEnvelope /> niteshk.jaithlya@gmail.com
              </Link>
              <div className="opacity-60 flex items-center gap-3">
                <FaPhoneAlt /> 98888121665
              </div>
              <div className="opacity-60 flex items-center gap-3">
                <FaLocationDot />
                22 C 16 Pratap Nagar, Opposite NRI COLONY, JAIPUR 302017
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-2 items-center justify-between border-t-2 pt-4 border-gray-500">
            ...
            <div className="flex flex-col md:flex-row gap-2 items-center justify-center">
              ...
              <div className="text-[0.7rem] md:text-[0.8rem]">
                <Link
                  href="/terms"
                  className="text-primary px-2 border-x-2 cursor-pointer border-gray-500"
                >
...
export function BasicPlan({ plan }) {
  return (
    <div className="w-fit bg-[#0168A826] mx-auto px-[16px] md:px-[24px] py-[24px] rounded-[16px] flex items-start">
      <div>
        <div className="flex gap-2">
          <h3 className="font-bold text-[var(--accent-1)] md:text-[20px]">
            Basic
          </h3>
          <button className="bg-white text-[var(--accent-1)] text-[8px] font-bold px-2 py-1 border-[1px] border-[var(--accent-1)] rounded-[4px]">
            3 Day Free Trial
          </button>
        </div>
        ...
        <p className="max-w-[40ch] text-[8px] md:text-[10px] text-[#263238] mb-4 md:mb-6">
          <strong>Best For:</strong>&nbsp; Individuals looking to prevent
          diabetes with expert guidance
        </p>
        <Link
          href="#register"
          className="bg-[var(--accent-1)] text-white font-bold text-[12px] md:text-[20px] px-4 py-2 rounded-md"
        >
          Enquire Now
        </Link>
      </div>
      <div className="min-w-[45%] md:ml-4">
        <h3 className="text-[7px] md:text-[12px] text-[#00000080] font-bold mb-2">
          What*nbsp;s Included
        </h3>
        {plan.included.map((item) => (
          <div key={item} className="mb-1 md:mb-2 flex items-center gap-1">
...
export function PopularPlan({ plan }) {
  return (
    <div className="w-fit mt-[40px] md:mt-[40px] lg:mt-0 mx-auto px-[16px] md:px-[24px] py-[24px] rounded-[16px] flex items-start border-[1px] border-[#0168A826] relative">
      ...
      <div>
        ...
        <Link
          href="#register"
          className="bg-[var(--accent-1)] text-white font-bold text-[8px] md:text-[20px] px-4 py-2 rounded-md"
        >
          Enquire Now
        </Link>
      </div>
      <div className="min-w-[45%] md:ml-4">
        ...
        {plan.included.map((item, index) => (
          <div key={index} className="mb-1 md:mb-2 flex items-center gap-1">
            <IoCheckmarkCircle className="min-w-[20px] min-h-[20px]" />
            <p className="text-[8px] md:text-[16px] leading-[1.2]">{item}</p>
          </div>
        ))}
